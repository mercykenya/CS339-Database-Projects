...
public class HeapPage implements Page {
    ...
    public void deleteTuple(Tuple t) throws DbException {
        ...
        PageId tuplePageId = rid.getPageId();
        int tupleSlot = rid.getTupleNumber();

        if (!tuplePageId.equals(pid) || !isSlotUsed(tupleSlot)) {
            throw new DbException("Tuple not found or slot is empty");
        }
    ...
    public void insertTuple(Tuple t) throws DbException {
        // DONE
        // Check if the tuple's TupleDesc matches this page's TupleDesc
        if (!t.getTupleDesc().equals(td)) {
            throw new DbException("TupleDesc does not match.");
        }

         // If no empty slot was found, throw an exception
